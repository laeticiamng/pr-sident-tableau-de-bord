...
describe("OKRProgress", () => {
  it("renders empty state when no okrs provided", () => {
    render(<OKRProgress />);
    expect(screen.getByText("Aucun OKR configuré")).toBeInTheDocument();
  });

  it("renders with data when okrs prop is provided", () => {
    render(<OKRProgress okrs={TEST_OKRS} />);
