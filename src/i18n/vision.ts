  ...
  fr: {
    ...
    history: {
      ...
      items: [
        ...
        { date: "Début 2026", title: "Siège Social Numérique & Expansion", description: "Création du Siège Social Numérique — Centre de commandement unifié avec IA intégrée. Lancement d'UrgenceOS (urgences hospitalières), Track Triumph (compétition musicale) et Gouvernance Agents IA (certification IA), portant l'écosystème à 8 plateformes." },
