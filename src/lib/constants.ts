...
export const MANAGED_PLATFORMS = [
  ...
  },
  {
    ...
    description: "Plateforme de compétition musicale où les artistes soumettent leurs morceaux chaque semaine et la communauté vote. Feed immersif, notation multi-critères (émotion, originalité, production), classements hebdomadaires et Hall of Fame. L'arène où le talent musical rencontre son public.",
