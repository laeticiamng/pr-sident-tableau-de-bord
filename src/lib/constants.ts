...
export const MANAGED_PLATFORMS = [
  ...
  },
  {
    ...
    description: "Growth OS : 39 employés IA premium (37 départements + 2 Direction CGO/QCO). Core OS avec RBAC, Approval Gate, Audit Log, Scheduler. 30 tables, 25 Edge Functions. 9 000€/mois vs 166 500€ équipe traditionnelle.",
    ...
    features: ["39 employés IA", "37 départements + 2 Direction", "Intégrations Google/Meta", "Voice Commands", "Approval Gate"],
    status: "production",
    lastCommit: null,
  },
  {
