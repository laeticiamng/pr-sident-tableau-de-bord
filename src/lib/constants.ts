...
export const MANAGED_PLATFORMS = [
  ...
  },
  {
    ...
    description: "Growth OS : 37 employés IA premium répartis en 9 départements (Marketing, Commercial, Finance, Sécurité, Produit, Ingénierie, Data, Support, Gouvernance). Core OS avec RBAC, Approval Gate, Audit Log, Scheduler. 30 tables, 25 Edge Functions. 9 000€/mois vs 166 500€ équipe traditionnelle.",
