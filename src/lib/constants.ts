...
export const MANAGED_PLATFORMS = [
  {
    ...
    description: "Plateforme de gestion du bien-être émotionnel pour les professionnels de santé et étudiants en médecine. 33 modules (Scan IA, Coach Nyvée, Musicothérapie, VR, Gamification XP). Stack : React 18, Supabase, 261 Edge Functions, 723 tables.",
  ...
  },
  {
    ...
    description: "PWA mobile-first de connexion sociale. Radar temps réel pour visualiser les personnes disponibles autour de toi (3 états : ouvert, conditionnel, occupé). Sessions binôme, ghost mode, chat de groupe. Stack : React 18, Mapbox, Lovable Cloud.",
  ...
  },
  {
    ...
    description: "Growth OS : 37 employés IA premium répartis en 9 départements (Marketing, Commercial, Finance, Sécurité, Produit, Ingénierie, Data, Support, Gouvernance). Core OS avec RBAC, Approval Gate, Audit Log, Scheduler. 9 000€/mois vs 166 500€ équipe traditionnelle.",
  ...
  },
  {
    ...
    description: "Plateforme anti-panique cognitive pour étudiants en médecine (ECN/EDN). Une chanson = un item médical maîtrisé. Medical AI Copilot (GPT-4o, Perplexity, Firecrawl), streaming SSE, génération musicale IA. Score audit 20/20, Grade Sécurité A+.",
