...
export const MANAGED_PLATFORMS = [
  ...
  },
  {
    ...
    description: "Growth OS : 39 employés IA premium (2 Direction CGO/QCO + 37 agents répartis dans 11 départements). Core OS avec RBAC, Approval Gate, Audit Log, Scheduler. 30 tables, 25 Edge Functions. 9 000€/mois vs 166 500€ équipe traditionnelle.",
    ...
    color: "bg-accent",
    stats: { modules: 11, tables: 30, edgeFunctions: 25, branches: 3, commits: 0, tests: 64 },
    features: ["39 employés IA", "11 départements + 2 Direction", "Intégrations Google/Meta", "Voice Commands", "Approval Gate"],
    status: "production",
    lastCommit: null,
  },
  {
