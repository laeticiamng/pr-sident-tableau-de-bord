...
export const PresidentCredentials = ({
  ...
  if (variant === "inline") {
    return (
      <a
        ...
        className={`inline-flex items-center gap-2 rounded-full border border-success/30 bg-success/5 px-4 py-1.5 text-xs font-medium text-success hover:bg-success/10 transition-colors ${className}`}
  ...
  return (
    <div
      className={`rounded-2xl border border-border/60 bg-secondary/30 p-6 ${className}`}
    >
